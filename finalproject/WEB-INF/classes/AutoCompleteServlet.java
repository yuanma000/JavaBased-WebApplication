		...
		{	
			...
			// check if user sent empty string
				if (!searchId.equals("")) 
				{
					...
					//System.out.println("AutoCompleteServelet line 77: sb is: "+sb);
					...
					if (namesAdded) 
					{
						//System.out.println("AutoCompleteServlet.java line 82:success");
			...
			if (action.equals("lookup"))
			{
				...
				HashMap<String,Car> data=AjaxUtility.getData();     	
